// app/tests/code/teacher/page.tsx
"use client"
...
export default function CodeKnowledgeTeacherPage() {
    const search = useSearchParams()
    const variantParam = (search.get("variant") as "pretest" | "posttest") || "pretest"
    ...
    const selectAll = () =>
        setKnownMap(STUDENT_ORDER.reduce((acc, g) => { acc[g] = true; return acc }, {} as Record<string, boolean>))
    ...
    const saveAll = async () => {
        ...
        // await fetch("/api/code-knowledge/bulk", { method: "POST", body: JSON.stringify(payload) })
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div key={`col-${colIdx}`} className="flex flex-col gap-3">
                    ...
                    >
                        ...
                        <div className="font-semibold uppercase tracking-wide">{g}</div>
